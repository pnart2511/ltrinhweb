<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="ChiTietSanPham.aspx.cs" Inherits="webSellPhone.ChiTietSanPham" %>
      ...
      <%--  <div class="breadcrumb">
        ...
        <div class="product-container">
            <div class="product-image">
                <img src="<%="./img/anh_sanpham/"+sp.anh_sp %>" alt="<%=sp.ten_sanPham %>">
            </div>
            <div class="product-details">
                <h1 class="product-title"><%=sp.ten_sanPham %></h1>
                <div class="product-rating">
                    <span>⭐️⭐️⭐️⭐️☆</span>
                    <a href="#reviews">2 Đánh giá</a> | <a href="#reviews">5 Bình luận</a>
                </div>
                <div class="product-price">
                    <span class="current-price"><%= string.Format("{0:N0}đ", sp.giaKM) %></span>
                    <span class="original-price"><%= string.Format("{0:N0}đ", sp.giaSP)%></span>
                </div>
                ...
                <div class="additional-services">
                    <label><input type="checkbox"> Gói bảo hiểm màn hình (818.000₫)</label>
                    <label><input type="checkbox"> Gói dịch vụ H.Plus (1.472.000₫)</label>
                </div>
                <div class="action-buttons">
                    <a class="buy-now-button" href="<%= "ChiTietDatHang.aspx?IDSP=" + sp.id_sanpham.ToString() %>">Mua Ngay</a>

                    <a class="buy-now-button" id ="add-to-cart" href="<%= "ChiTietDatHang.aspx?IDSP=" + sp.id_sanpham.ToString() %>"><i class="fa-solid fa-cart-shopping"></i></a>
                </div>
         ...
         <div class="container">
                <div class="warranty">
                    ...
                    <ul>
                        ...
                        <li><i class="fa-solid fa-ticket"></i>-PIN:<%=sp.pin %></li>
                        <li><i class="fa-solid fa-circle-info"></i>-Mô Tả:<%=sp.mo_ta %></li
                        <li><i class="fa-solid fa-warehouse"></i>-Còn:<%=sp.ton_kho%> chiếc</li>
