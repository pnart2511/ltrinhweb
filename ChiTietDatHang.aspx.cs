...
namespace webSellPhone
{
    public partial class ChiTietDatHang : System.Web.UI.Page
    {
        ...
        public static tb_sp sp_dathang = new tb_sp();
        ...
        void load()
        {
            long idselect = Convert.ToInt64(Request.QueryString["IDSP"]);
         
            var dataFrom = from q in SQL.tb_sps where q.id_sanpham == idselect select q;
        ...
        protected void btnDat_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                info.id_san_pham = sp_dathang.id_sanpham;
