<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="ChiTietDatHangPhuKien.aspx.cs" Inherits="webSellPhone.ChiTietDatHangPhuKien" %>
...
.container input[type="submit"]:hover {
   ...
   <div class="container" >
       <h1>Bạn đang mua <%=sp_dathang.ten_phu_kien %></h1>
         <img src="<%="./img/anh_sanpham/"+sp_dathang.anh_pk %>" alt="Ảnh sản phẩm">
